...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Directive*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Directive*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Instruction_type&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Instruction_type& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_LITERAL || tok == token::TOK_SYMBOL || tok == token::TOK_REGISTER || tok == token::TOK_COMMENT);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      {
        return symbol_type (token::TOK_HASHTAG, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_HASHTAG, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_REGISTER (string v, location_type l)
      {
      ...
      static
      symbol_type
      make_REGISTER (const string& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_JEQ (location_type l)
      {
        return symbol_type (token::TOK_JEQ, std::move (l));
      }
#else
      static
      symbol_type
      make_JEQ (const location_type& l)
      {
        return symbol_type (token::TOK_JEQ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_JNE (location_type l)
      {
        return symbol_type (token::TOK_JNE, std::move (l));
      }
#else
      static
      symbol_type
      make_JNE (const location_type& l)
      {
        return symbol_type (token::TOK_JNE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_JGT (location_type l)
      {
        return symbol_type (token::TOK_JGT, std::move (l));
      }
#else
      static
      symbol_type
      make_JGT (const location_type& l)
      {
        return symbol_type (token::TOK_JGT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_CMP (location_type l)
      {
        return symbol_type (token::TOK_CMP, std::move (l));
      }
#else
      static
      symbol_type
      make_CMP (const location_type& l)
      {
        return symbol_type (token::TOK_CMP, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_TEST, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_TEST, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LDR (location_type l)
      {
        return symbol_type (token::TOK_LDR, std::move (l));
      }
#else
      static
      symbol_type
      make_LDR (const location_type& l)
      {
        return symbol_type (token::TOK_LDR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_COMMENT (string v, location_type l)
      {
      ...
      static
      symbol_type
      make_COMMENT (const string& v, const location_type& l)
      {
...
#line 2201 "./misc/parser/parser.hpp"
