...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      char dummy1[sizeof (eInstructionIdentifier)];
      ...
      // NT_SymbolList
      // NT_LiteralList
      char dummy3[sizeof (vector<pair<string, eOperandType>>)];
    };
    ...
    TOK_EQU = 9,                   // EQU
    TOK_END = 10,                  // END
    TOK_SYMBOL = 11,               // SYMBOL
    TOK_LITERAL = 12,              // LITERAL
    TOK_COMMA = 13                 // ","
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_NT_Program = 15,                       // NT_Program
        S_NT_Line = 16,                          // NT_Line
        S_NT_Directive = 17,                     // NT_Directive
        S_NT_DirectiveWithList = 18,             // NT_DirectiveWithList
        S_NT_DirectiveSingleArgument = 19,       // NT_DirectiveSingleArgument
        S_NT_DirectiveWithSymbolList = 20,       // NT_DirectiveWithSymbolList
        S_NT_DirectiveIdentifier = 21,           // NT_DirectiveIdentifier
        S_NT_SymbolList = 22,                    // NT_SymbolList
        S_NT_LiteralList = 23                    // NT_LiteralList
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_NT_LiteralList: // NT_LiteralList
        value.move< vector<pair<string, eOperandType>> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, vector<pair<string, eOperandType>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const vector<pair<string, eOperandType>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_NT_SymbolList: // NT_SymbolList
      case symbol_kind::S_NT_LiteralList: // NT_LiteralList
        value.template destroy< vector<pair<string, eOperandType>> > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::TOK_SYMBOL <= tok && tok <= token::TOK_LITERAL));
#endif
      }
    };
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_NT_SymbolList: // NT_SymbolList
      case symbol_kind::S_NT_LiteralList: // NT_LiteralList
        value.copy< vector<pair<string, eOperandType>> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_NT_SymbolList: // NT_SymbolList
      case symbol_kind::S_NT_LiteralList: // NT_LiteralList
        value.move< vector<pair<string, eOperandType>> > (YY_MOVE (s.value));
        break;
...
#line 1576 "./misc/parser/parser.hpp"
