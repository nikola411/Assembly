...
namespace yy {
#line 187 "./src/parser/parser.hpp"
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_EOF || tok == token::TOK_ASSIGN || tok == token::TOK_MINUS || tok == token::TOK_PLUS || tok == token::TOK_STAR || tok == token::TOK_SLASH || tok == token::TOK_LPAREN || tok == token::TOK_RPAREN || tok == token::TOK_SYMBOL || tok == token::TOK_GLOBAL || tok == token::TOK_EXTERN || tok == token::TOK_SECTION || tok == token::TOK_WORD || tok == token::TOK_SKIP || tok == token::TOK_ASCII || tok == token::TOK_EQU || tok == token::TOK_END);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      {
        return symbol_type (token::TOK_SYMBOL, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_SYMBOL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#line 1353 "./src/parser/parser.hpp"
