...
private:
    ...
    std::string get_addressing_byte_value(Addressing_type addr_type, Label_type label_type, const std::type_info& instruction_type) const;
    std::string get_symbol_value_or_relocate(std::string symbol, Addressing_type addr_type, bool is_directive);
